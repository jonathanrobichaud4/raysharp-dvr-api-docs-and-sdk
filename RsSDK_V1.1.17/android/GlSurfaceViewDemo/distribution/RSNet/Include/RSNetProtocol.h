...
#define HDPROLogin                  627
#define HDPROSearchDev              628
...
typedef enum
{
	...
	CoBitAry_45,    //是否支持ftp页面和DDNS页面json透传 1:支持，0：不支持    
	CoBitAry_46,    //是否隐藏buzzer， 1 隐藏 0 不隐藏
	CoBitAry_47,    //是否隐藏DST， 1 隐藏 0 不隐藏    
	CoBitAry_48,    //是否支持Alarm Voice Prompts功能  
	CoBitAry_49//是否显示智能页面画框按钮
}ControlBitArray_E;
