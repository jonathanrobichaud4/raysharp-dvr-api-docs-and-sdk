...
#ifdef _WIN64
#  pragma comment(lib, "../windows/Bin64/RSNet64.lib")
#  pragma comment(lib, "../windows/Bin64/RSPlay64.lib")
#else
...
#else
#ifdef _WIN64
#  pragma comment(lib, "../Bin64/RSNet64.lib")
#  pragma comment(lib, "../Bin64/RSPlay64.lib")
#else
