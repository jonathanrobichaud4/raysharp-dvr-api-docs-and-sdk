...
void SwannCloSto::StructToJson(int n)
{
    ...
    std::string str = Base64::Encode((unsigned char*)m_CloudStorageSet.Dropboxtoken, (int)strlen((char*)m_CloudStorageSet.Dropboxtoken));
...
#if defined(RS_IPHONE)||defined(RS_ANDROID)
    str = Base64::Encode((unsigned char*)m_vec[n].DriveName, (int)strlen((char*)m_vec[n].DriveName));
