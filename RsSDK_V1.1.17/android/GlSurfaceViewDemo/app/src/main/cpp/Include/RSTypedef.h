...
typedef enum
{
	ABILITY_TYPE_ODDETECTION = 0,//遮挡报警
	ABILITY_TYPE_DL,
	ABILITY_TYPE_IVALINES,
	ABILITY_TYPE_HKPTZ,
	ABILITY_TYPE_NEWPTZ,
	ABILITY_TYPE_INTELLIGENT_PLUS_PIR = 5,
	ABILITY_TYPE_MOTION_PIR,
	ABILITY_TYPE_IR_LED,
	ABILITY_TYPE_IR_SCHEDULE,
	ABILITY_TYPE_IR_TRIGGER,
	ABILITY_TYPE_CH256_IPC = 10,
	ABILITY_TYPE_IFRAME_INTERVAL,
	ABILITY_TYPE_AFOCUS,
	ABILITY_TYPE_IMAGE_DAY_AND_NIGHT,
	ABILITY_TYPE_SUPPORT_VBR_CBR,
	ABILITY_TYPE_SHOW_DLFD_PAGE = 15,
	ABILITY_TYPE_SUPPORT_WATERMARK,
	ABILITY_TYPE_DISSUPPORT_OSD_CUSTOM, //OSD位置不支持自定义
...
typedef enum
{
    ...
    PROTO_TYPE_AMTK,	  /*VC客户(已不再使用)*/
    PROTO_TYPE_SHANY,	  /*VC客户(已不再使用)*/
    PROTO_TYPE_ZHUOWEI,   /*URMET客户卓威视讯(创安源生产)*/
    PROTO_TYPE_MINGJING,  /*VC客户(对接明景私有协议)*/
    PROTO_TYPE_FSAN = 10, /*IQCCTV客户(也叫 Y3K,  XVISION) (对接富视安私有协议)*/
    PROTO_TYPE_QIHAN,     /*BOLIDE(对接旗翰私有协议)*/
    ...
    PROTO_TYPE_JINGYANG,
    PROTO_TYPE_DAHUA = 20, /*大华，lorex版本增加了大华的私有协议搜索*/
    PROTO_TYPE_WIFI_SONIX,
    PROTO_TYPE_BATTERY_SONIX,
    PROTO_TYPE_SPECO,
    PROTO_TYPE_BATTERY_RYSHARP,
    PROTO_TYPE_SVNP = 25,        /*SATVISION客户(SVNP协议，实际走ONVIF)*/
    PROTO_TYPE_NULL, /* 需小于32  0-31： 为客户专用协议 32-47: 为自定义协议 48-79: 为预留客户专用协议 */
